...
- **Cost**: ~$0.05/article for Phase 1.5 alone (DataForSEO $0.01 for 5 domains + DeepSeek Reasoner for integrity/quality + Gemini Pro for fact extraction). ~$0.005/article Phase 1.5 after caching (80%+ cache hit rate expected after 20 articles). Iterative search adds negligible cost (<$0.001) when triggered. **Full pipeline cost** (all 7 phases including DeepSeek-R1 research, DeepSeek-V3 psychology, Claude 3.5 Sonnet writer with best-of-N retries, readability service, feedback loop): ~$0.15-$0.30 per generation. With the $10 budget this allows approximately 35-65 full generations.
